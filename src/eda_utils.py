...
def calculate_descriptive_stats(df: pd.DataFrame, numeric_columns: List[str] = None) -> pd.DataFrame:
    """
...
def calculate_loss_ratio(df: pd.DataFrame, claims_col: str = "charges", premium_col: str = "charges") -> Dict:
    """
...
def calculate_loss_ratio_by_group(df: pd.DataFrame, group_col: str, value_col: str = "charges") -> pd.DataFrame:
    """
...
def calculate_correlation_matrix(df: pd.DataFrame, numeric_columns: List[str] = None) -> pd.DataFrame:
    """
